...
public String  _dataset    = "Fall2018";
public int     _pass       = 1;
public boolean _outbending = false;
...
protected double eloss_pip(double pion_p, double pip_theta, double pion_det, boolean outbending){
    ...
    if(outbending == false){ // INBENDING
        if(pion_det == 2){   // Forward Detector
            if(pip_theta < 27){                                       dp_pion =  0.00342646 + (-0.00282934) *pion_p + (0.00205983)   *Math.pow(pion_p,2) + (-0.00043158)  *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta < 27 && pion_p >= 2.5){                      dp_pion =  0.00342646 + (-0.00282934) *2.5    + (0.00205983)   *Math.pow(2.5,2)    + (-0.00043158)  *Math.pow(2.5,3)    + (0) *Math.pow(2.5,4);}
            if(pip_theta > 27 && pip_theta < 28){                     dp_pion =  0.00328565 + (-0.00376042) *pion_p + (0.00433886)   *Math.pow(pion_p,2) + (-0.00141614)  *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 27 && pip_theta < 28 && pion_p >= 1.83){   dp_pion =  0.00328565 + (-0.00376042) *1.83   + (0.00433886)   *Math.pow(1.83,2)   + (-0.00141614)  *Math.pow(1.83,3)   + (0) *Math.pow(1.83,4);}
            if(pip_theta > 28 && pip_theta < 29){                     dp_pion =  0.00328579 + (-0.00281121) *pion_p + (0.00342749)   *Math.pow(pion_p,2) + (-0.000932614) *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 28 && pip_theta < 29 && pion_p >= 2){      dp_pion =  0.00328579 + (-0.00281121) *2      + (0.00342749)   *Math.pow(2,2)      + (-0.000932614) *Math.pow(2,3)      + (0) *Math.pow(2,4);}
            if(pip_theta > 29 && pip_theta < 30){                     dp_pion =  0.00167358 + (0.00441871)  *pion_p + (-0.000834667) *Math.pow(pion_p,2) + (-0.000137968) *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 29 && pip_theta < 30 && pion_p >= 1.9){    dp_pion =  0.00167358 + (0.00441871)  *1.9    + (-0.000834667) *Math.pow(1.9,2)    + (-0.000137968) *Math.pow(1.9,3)    + (0) *Math.pow(1.9,4);}
            if(pip_theta > 30 && pip_theta < 31){                     dp_pion =  0.00274159 + (0.00635686)  *pion_p + (-0.00380977)  *Math.pow(pion_p,2) + (0.00071627)   *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 30 && pip_theta < 31 && pion_p >= 1.9){    dp_pion =  0.00274159 + (0.00635686)  *1.9    + (-0.00380977)  *Math.pow(1.9,2)    + (0.00071627)   *Math.pow(1.9,3)    + (0) *Math.pow(1.9,4);}
            if(pip_theta > 31 && pip_theta < 32){                     dp_pion =  0.00450241 + (0.00248969)  *pion_p + (-0.00336795)  *Math.pow(pion_p,2) + (0.00111193)   *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 31 && pip_theta < 32 && pion_p >= 1.8){    dp_pion =  0.00450241 + (0.00248969)  *1.8    + (-0.00336795)  *Math.pow(1.8,2)    + (0.00111193)   *Math.pow(1.8,3)    + (0) *Math.pow(1.8,4);}
            if(pip_theta > 32 && pip_theta < 33){                     dp_pion =  0.00505593 + (-0.00246203) *pion_p + (0.00172984)   *Math.pow(pion_p,2) + (-0.000406701) *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 32 && pip_theta < 33 && pion_p >= 1.8){    dp_pion =  0.00505593 + (-0.00246203) *1.8    + (0.00172984)   *Math.pow(1.8,2)    + (-0.000406701) *Math.pow(1.8,3)    + (0) *Math.pow(1.8,4);}
            if(pip_theta > 33 && pip_theta < 34){                     dp_pion =  0.00273402 + (0.00440449)  *pion_p + (-0.00373488)  *Math.pow(pion_p,2) + (0.000996612)  *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 33 && pip_theta < 34 && pion_p >= 1.8){    dp_pion =  0.00273402 + (0.00440449)  *1.8    + (-0.00373488)  *Math.pow(1.8,2)    + (0.000996612)  *Math.pow(1.8,3)    + (0) *Math.pow(1.8,4);}
            if(pip_theta > 34 && pip_theta < 35){                     dp_pion =  0.00333542 + (0.00439874)  *pion_p + (-0.00397776)  *Math.pow(pion_p,2) + (0.00105586)   *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 34 && pip_theta < 35 && pion_p >= 1.8){    dp_pion =  0.00333542 + (0.00439874)  *1.8    + (-0.00397776)  *Math.pow(1.8,2)    + (0.00105586)   *Math.pow(1.8,3)    + (0) *Math.pow(1.8,4);}
            if(pip_theta > 35 && pip_theta < 36){                     dp_pion =  0.00354663 + (0.00565397)  *pion_p + (-0.00513503)  *Math.pow(pion_p,2) + (0.00153346)   *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 35 && pip_theta < 36 && pion_p >= 1.8){    dp_pion =  0.00354663 + (0.00565397)  *1.8    + (-0.00513503)  *Math.pow(1.8,2)    + (0.00153346)   *Math.pow(1.8,3)    + (0) *Math.pow(1.8,4);}
            if(pip_theta > 36 && pip_theta < 37){                     dp_pion =  0.00333909 + (0.00842367)  *pion_p + (-0.0077321)   *Math.pow(pion_p,2) + (0.0022489)    *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 36 && pip_theta < 37 && pion_p >= 1.8){    dp_pion =  0.00333909 + (0.00842367)  *1.8    + (-0.0077321)   *Math.pow(1.8,2)    + (0.0022489)    *Math.pow(1.8,3)    + (0) *Math.pow(1.8,4);}
            if(pip_theta > 37 && pip_theta < 38){                     dp_pion =  0.00358828 + (0.0112108)   *pion_p + (-0.0133854)   *Math.pow(pion_p,2) + (0.00486924)   *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 37 && pip_theta < 38 && pion_p >= 1.4){    dp_pion =  0.00358828 + (0.0112108)   *1.4    + (-0.0133854)   *Math.pow(1.4,2)    + (0.00486924)   *Math.pow(1.4,3)    + (0) *Math.pow(1.4,4);}
            if(pip_theta > 38 && pip_theta < 39){                     dp_pion =  0.00354343 + (0.0117121)   *pion_p + (-0.0129649)   *Math.pow(pion_p,2) + (0.00455602)   *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 38 && pip_theta < 39 && pion_p >= 1.3){    dp_pion =  0.00354343 + (0.0117121)   *1.3    + (-0.0129649)   *Math.pow(1.3,2)    + (0.00455602)   *Math.pow(1.3,3)    + (0) *Math.pow(1.3,4);}
            if(pip_theta > 39 && pip_theta < 40){                     dp_pion = -0.00194951 + (0.0409713)   *pion_p + (-0.0595861)   *Math.pow(pion_p,2) + (0.0281588)    *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 39 && pip_theta < 40 && pion_p >= 0.9){    dp_pion = -0.00194951 + (0.0409713)   *0.9    + (-0.0595861)   *Math.pow(0.9,2)    + (0.0281588)    *Math.pow(0.9,3)    + (0) *Math.pow(0.9,4);}
            if(pip_theta > 40 && pip_theta < 41){                     dp_pion = -0.0099217  + (0.0808096)   *pion_p + (-0.119836)    *Math.pow(pion_p,2) + (0.0559553)    *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 40 && pip_theta < 41 && pion_p >= 0.75){   dp_pion = -0.0099217  + (0.0808096)   *0.75   + (-0.119836)    *Math.pow(0.75,2)   + (0.0559553)    *Math.pow(0.75,3)   + (0) *Math.pow(0.75,4);}
            if(pip_theta > 41 && pip_theta < 42){                     dp_pion =  0.00854898 + (0.00025037)  *pion_p + (-0.0113992)   *Math.pow(pion_p,2) + (0.0145178)    *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 41 && pip_theta < 42 && pion_p >= 0.65){   dp_pion =  0.00854898 + (0.00025037)  *0.65   + (-0.0113992)   *Math.pow(0.65,2)   + (0.0145178)    *Math.pow(0.65,3)   + (0) *Math.pow(0.65,4);}
            if(pip_theta > 42){                                       dp_pion =  0.00564818 + (0.00706606)  *pion_p + (0.0042602)    *Math.pow(pion_p,2) + (-0.01141)     *Math.pow(pion_p,3) + (0) *Math.pow(pion_p,4);}
            if(pip_theta > 42 && pion_p >= 0.65){                     dp_pion =  0.00564818 + (0.00706606)  *0.65   + (0.0042602)    *Math.pow(0.65,2)   + (-0.01141)     *Math.pow(0.65,3)   + (0) *Math.pow(0.65,4);}
        }
        if(pion_det == 3){  // Central Detector
            if(pip_theta < 39){                                       dp_pion = -0.045      + (-0.102652) + (0.455589) *pion_p + (-0.671635)   *Math.pow(pion_p,2) + (0.303814)   *Math.pow(pion_p,3);}
            if(pip_theta < 39  && pion_p >= 0.7){                     dp_pion = -0.045      + (-0.102652) + (0.455589) *0.7    + (-0.671635)   *Math.pow(0.7,2)    + (0.303814)   *Math.pow(0.7,3);}
            if(pip_theta > 39  && pip_theta < 40){                    dp_pion =  0.0684552  + (-0.766492)              *pion_p + (1.73092)     *Math.pow(pion_p,2) + (-1.46215)   *Math.pow(pion_p,3) + (0.420127) *Math.pow(pion_p,4);}
            if(pip_theta > 39  && pip_theta < 40 && pion_p >= 1.4){   dp_pion =  0.0684552  + (-0.766492)              *1.4    + (1.73092)     *Math.pow(1.4,2)    + (-1.46215)   *Math.pow(1.4,3)    + (0.420127) *Math.pow(1.4,4);}
            if(pip_theta > 40  && pip_theta < 41){                    dp_pion =  0.751549   + (-7.4593)                *pion_p + (26.8037)     *Math.pow(pion_p,2) + (-47.1576)   *Math.pow(pion_p,3) + (43.8527)  *Math.pow(pion_p,4) + (-20.7039) *Math.pow(pion_p,5) + (3.90931)  *Math.pow(pion_p,6);}
            if(pip_theta > 40  && pip_theta < 41 && pion_p >= 1.45){  dp_pion =  0.751549   + (-7.4593)                *1.45   + (26.8037)     *Math.pow(1.45,2)   + (-47.1576)   *Math.pow(1.45,3)   + (43.8527)  *Math.pow(1.45,4)   + (-20.7039) *Math.pow(1.45,5)   + (3.90931)  *Math.pow(1.45,6);}
            if(pip_theta > 41  && pip_theta < 42){                    dp_pion = -1.35043    + (10.0788)                *pion_p + (-30.4829)    *Math.pow(pion_p,2) + (47.7792)    *Math.pow(pion_p,3) + (-40.996)  *Math.pow(pion_p,4) + (18.2662)  *Math.pow(pion_p,5) + (-3.30449) *Math.pow(pion_p,6);}
            if(pip_theta > 41  && pip_theta < 42 && pion_p >= 1.2){   dp_pion = -1.35043    + (10.0788)                *1.2    + (-30.4829)    *Math.pow(1.2,2)    + (47.7792)    *Math.pow(1.2,3)    + (-40.996)  *Math.pow(1.2,4)    + (18.2662)  *Math.pow(1.2,5)    + (-3.30449) *Math.pow(1.2,6);}
            if(pip_theta > 42  && pip_theta < 43){                    dp_pion = -0.0231195  + (0.0744589)              *pion_p + (-0.0807029)  *Math.pow(pion_p,2) + (0.0264266)  *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 42  && pip_theta < 43 && pion_p >= 1.3){   dp_pion = -0.0231195  + (0.0744589)              *1.3    + (-0.0807029)  *Math.pow(1.3,2)    + (0.0264266)  *Math.pow(1.3,3)    + (0)        *Math.pow(1.3,4);}
            if(pip_theta > 43  && pip_theta < 44){                    dp_pion = -0.00979928 + (0.0351043)              *pion_p + (-0.0365865)  *Math.pow(pion_p,2) + (0.00977218) *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 43  && pip_theta < 44 && pion_p >= 1.1){   dp_pion = -0.00979928 + (0.0351043)              *1.1    + (-0.0365865)  *Math.pow(1.1,2)    + (0.00977218) *Math.pow(1.1,3)    + (0)        *Math.pow(1.1,4);}
            if(pip_theta > 44  && pip_theta < 45){                    dp_pion =  0.00108491 + (-0.00924885)            *pion_p + (0.0216431)   *Math.pow(pion_p,2) + (-0.0137762) *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 44  && pip_theta < 45 && pion_p >= 1.1){   dp_pion =  0.00108491 + (-0.00924885)            *1.1    + (0.0216431)   *Math.pow(1.1,2)    + (-0.0137762) *Math.pow(1.1,3)    + (0)        *Math.pow(1.1,4);}
            if(pip_theta > 45  && pip_theta < 55){                    dp_pion =  0.0092263  + (-0.0676178)             *pion_p + (0.168778)    *Math.pow(pion_p,2) + (-0.167463)  *Math.pow(pion_p,3) + (0.05661)  *Math.pow(pion_p,4);}
            if(pip_theta > 45  && pip_theta < 55 && pion_p >= 1.3){   dp_pion =  0.0092263  + (-0.0676178)             *1.3    + (0.168778)    *Math.pow(1.3,2)    + (-0.167463)  *Math.pow(1.3,3)    + (0.05661)  *Math.pow(1.3,4);}
            if(pip_theta > 55  && pip_theta < 65){                    dp_pion =  0.00805642 + (-0.0670962)             *pion_p + (0.188536)    *Math.pow(pion_p,2) + (-0.20571)   *Math.pow(pion_p,3) + (0.0765)   *Math.pow(pion_p,4);}
            if(pip_theta > 55  && pip_theta < 65 && pion_p >= 1.05){  dp_pion =  0.00805642 + (-0.0670962)             *1.05   + (0.188536)    *Math.pow(1.05,2)   + (-0.20571)   *Math.pow(1.05,3)   + (0.0765)   *Math.pow(1.05,4);}
            if(pip_theta > 65  && pip_theta < 75){                    dp_pion =  0.00312202 + (-0.0269717)             *pion_p + (0.0715236)   *Math.pow(pion_p,2) + (-0.0545622) *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 65  && pip_theta < 75 && pion_p >= 0.75){  dp_pion =  0.00312202 + (-0.0269717)             *0.75   + (0.0715236)   *Math.pow(0.75,2)   + (-0.0545622) *Math.pow(0.75,3)   + (0)        *Math.pow(0.75,4);}
            if(pip_theta > 75  && pip_theta < 85){                    dp_pion =  0.00424971 + (-0.0367683)             *pion_p + (0.10417)     *Math.pow(pion_p,2) + (-0.0899651) *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 75  && pip_theta < 85 && pion_p >= 0.65){  dp_pion =  0.00424971 + (-0.0367683)             *0.65   + (0.10417)     *Math.pow(0.65,2)   + (-0.0899651) *Math.pow(0.65,3)   + (0)        *Math.pow(0.65,4);}
            if(pip_theta > 85  && pip_theta < 95){                    dp_pion =  0.00654123 + (-0.0517915)             *pion_p + (0.147888)    *Math.pow(pion_p,2) + (-0.14253)   *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 85  && pip_theta < 95 && pion_p >= 0.5){   dp_pion =  0.00654123 + (-0.0517915)             *0.5    + (0.147888)    *Math.pow(0.5,2)    + (-0.14253)   *Math.pow(0.5,3)    + (0)        *Math.pow(0.5,4);}
            if(pip_theta > 95  && pip_theta < 105){                   dp_pion = -0.00111721 + (0.00478119)             *pion_p + (0.0158753)   *Math.pow(pion_p,2) + (-0.052902)  *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 95  && pip_theta < 105 && pion_p >= 0.45){ dp_pion = -0.00111721 + (0.00478119)             *0.45   + (0.0158753)   *Math.pow(0.45,2)   + (-0.052902)  *Math.pow(0.45,3)   + (0)        *Math.pow(0.45,4);}
            if(pip_theta > 105 && pip_theta < 115){                   dp_pion = -0.00239839 + (0.00790738)             *pion_p + (0.0311713)   *Math.pow(pion_p,2) + (-0.104157)  *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 105 && pip_theta < 115 && pion_p >= 0.35){ dp_pion = -0.00239839 + (0.00790738)             *0.35   + (0.0311713)   *Math.pow(0.35,2)   + (-0.104157)  *Math.pow(0.35,3)   + (0)        *Math.pow(0.35,4);}
            if(pip_theta > 115 && pip_theta < 125){                   dp_pion = -0.00778793 + (0.0256774)              *pion_p + (0.0932503)   *Math.pow(pion_p,2) + (-0.32771)   *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 115 && pip_theta < 125 && pion_p >= 0.35){ dp_pion = -0.00778793 + (0.0256774)              *0.35   + (0.0932503)   *Math.pow(0.35,2)   + (-0.32771)   *Math.pow(0.35,3)   + (0)        *Math.pow(0.35,4);}
            if(pip_theta > 125 && pip_theta < 135){                   dp_pion = -0.00292778 + (-0.00536697)            *pion_p + (-0.00414351) *Math.pow(pion_p,2) + (0.0196431)  *Math.pow(pion_p,3) + (0)        *Math.pow(pion_p,4);}
            if(pip_theta > 125 && pip_theta < 135 && pion_p >= 0.35){ dp_pion = -0.00292778 + (-0.00536697)            *0.35   + (-0.00414351) *Math.pow(0.35,2)   + (0.0196431)  *Math.pow(0.35,3)   + (0)        *Math.pow(0.35,4);}
        }
    }
    if(outbending == true){ // OUTBENDING
        if(pion_det == 2){  // Forward Detector
            if(pip_theta < 27){                                       dp_pion = 0.00389945  + (-0.004062)    *pion_p + (0.00321842)  *Math.pow(pion_p,2) + (-0.000698299) *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta < 27 && pion_p >= 2.3){                      dp_pion = 0.00389945  + (-0.004062)    *2.3    + (0.00321842)  *Math.pow(2.3,2)    + (-0.000698299) *Math.pow(2.3,3)    + (0)          *Math.pow(2.3,4);}
            if(pip_theta > 27 && pip_theta < 28){                     dp_pion = 0.00727132  + (-0.0117989)   *pion_p + (0.00962999)  *Math.pow(pion_p,2) + (-0.00267005)  *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 27 && pip_theta < 28 && pion_p >= 1.7){    dp_pion = 0.00727132  + (-0.0117989)   *1.7    + (0.00962999)  *Math.pow(1.7,2)    + (-0.00267005)  *Math.pow(1.7,3)    + (0)          *Math.pow(1.7,4);}
            if(pip_theta > 28 && pip_theta < 29){                     dp_pion = 0.00844551  + (-0.0128097)   *pion_p + (0.00945956)  *Math.pow(pion_p,2) + (-0.00237992)  *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 28 && pip_theta < 29 && pion_p >= 2){      dp_pion = 0.00844551  + (-0.0128097)   *2      + (0.00945956)  *Math.pow(2,2)      + (-0.00237992)  *Math.pow(2,3)      + (0)          *Math.pow(2,4);}
            if(pip_theta > 29 && pip_theta < 30){                     dp_pion = 0.00959007  + (-0.0139218)   *pion_p + (0.0122966)   *Math.pow(pion_p,2) + (-0.0034012)   *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 29 && pip_theta < 30 && pion_p >= 1.9){    dp_pion = 0.00959007  + (-0.0139218)   *1.9    + (0.0122966)   *Math.pow(1.9,2)    + (-0.0034012)   *Math.pow(1.9,3)    + (0)          *Math.pow(1.9,4);}
            if(pip_theta > 30 && pip_theta < 31){                     dp_pion = 0.00542816  + (-5.10739e-05) *pion_p + (0.000572038) *Math.pow(pion_p,2) + (-0.000488883) *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 30 && pip_theta < 31 && pion_p >= 1.9){    dp_pion = 0.00542816  + (-5.10739e-05) *1.9    + (0.000572038) *Math.pow(1.9,2)    + (-0.000488883) *Math.pow(1.9,3)    + (0)          *Math.pow(1.9,4);}
            if(pip_theta > 31 && pip_theta < 32){                     dp_pion = 0.0060391   + (-0.000516936) *pion_p + (-0.00286595) *Math.pow(pion_p,2) + (0.00136604)   *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 31 && pip_theta < 32 && pion_p >= 1.8){    dp_pion = 0.0060391   + (-0.000516936) *1.8    + (-0.00286595) *Math.pow(1.8,2)    + (0.00136604)   *Math.pow(1.8,3)    + (0)          *Math.pow(1.8,4);}
            if(pip_theta > 32 && pip_theta < 33){                     dp_pion = 0.0140305   + (-0.0285832)   *pion_p + (0.0248799)   *Math.pow(pion_p,2) + (-0.00701311)  *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 32 && pip_theta < 33 && pion_p >= 1.6){    dp_pion = 0.0140305   + (-0.0285832)   *1.6    + (0.0248799)   *Math.pow(1.6,2)    + (-0.00701311)  *Math.pow(1.6,3)    + (0)          *Math.pow(1.6,4);}
            if(pip_theta > 33 && pip_theta < 34){                     dp_pion = 0.010815    + (-0.0194244)   *pion_p + (0.0174474)   *Math.pow(pion_p,2) + (-0.0049764)   *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 33 && pip_theta < 34 && pion_p >= 1.5){    dp_pion = 0.010815    + (-0.0194244)   *1.5    + (0.0174474)   *Math.pow(1.5,2)    + (-0.0049764)   *Math.pow(1.5,3)    + (0)          *Math.pow(1.5,4);}
            if(pip_theta > 34 && pip_theta < 35){                     dp_pion = 0.0105522   + (-0.0176248)   *pion_p + (0.0161142)   *Math.pow(pion_p,2) + (-0.00472288)  *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 34 && pip_theta < 35 && pion_p >= 1.6){    dp_pion = 0.0105522   + (-0.0176248)   *1.6    + (0.0161142)   *Math.pow(1.6,2)    + (-0.00472288)  *Math.pow(1.6,3)    + (0)          *Math.pow(1.6,4);}
            if(pip_theta > 35 && pip_theta < 36){                     dp_pion = 0.0103938   + (-0.0164003)   *pion_p + (0.0164045)   *Math.pow(pion_p,2) + (-0.00517012)  *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 35 && pip_theta < 36 && pion_p >= 1.5){    dp_pion = 0.0103938   + (-0.0164003)   *1.5    + (0.0164045)   *Math.pow(1.5,2)    + (-0.00517012)  *Math.pow(1.5,3)    + (0)          *Math.pow(1.5,4);}
            if(pip_theta > 36 && pip_theta < 37){                     dp_pion = 0.0441471   + (-0.183937)    *pion_p + (0.338784)    *Math.pow(pion_p,2) + (-0.298985)    *Math.pow(pion_p,3) + (0.126905)   *Math.pow(pion_p,4) + (-0.0208286) *Math.pow(pion_p,5);}
            if(pip_theta > 36 && pip_theta < 37 && pion_p >= 1.8){    dp_pion = 0.0441471   + (-0.183937)    *1.8    + (0.338784)    *Math.pow(1.8,2)    + (-0.298985)    *Math.pow(1.8,3)    + (0.126905)   *Math.pow(1.8,4)    + (-0.0208286) *Math.pow(1.8,5);}
            if(pip_theta > 37 && pip_theta < 38){                     dp_pion = 0.0726119   + (-0.345004)    *pion_p + (0.697789)    *Math.pow(pion_p,2) + (-0.685948)    *Math.pow(pion_p,3) + (0.327195)   *Math.pow(pion_p,4) + (-0.0605621) *Math.pow(pion_p,5);}
            if(pip_theta > 37 && pip_theta < 38 && pion_p >= 1.7){    dp_pion = 0.0726119   + (-0.345004)    *1.7    + (0.697789)    *Math.pow(1.7,2)    + (-0.685948)    *Math.pow(1.7,3)    + (0.327195)   *Math.pow(1.7,4)    + (-0.0605621) *Math.pow(1.7,5);}
            if(pip_theta > 38 && pip_theta < 39){                     dp_pion = 0.0247648   + (-0.0797376)   *pion_p + (0.126535)    *Math.pow(pion_p,2) + (-0.086545)    *Math.pow(pion_p,3) + (0.0219304)  *Math.pow(pion_p,4);}
            if(pip_theta > 38 && pip_theta < 39 && pion_p >= 1.6){    dp_pion = 0.0247648   + (-0.0797376)   *1.6    + (0.126535)    *Math.pow(1.6,2)    + (-0.086545)    *Math.pow(1.6,3)    + (0.0219304)  *Math.pow(1.6,4);}
            if(pip_theta > 39 && pip_theta < 40){                     dp_pion = 0.0208867   + (-0.0492068)   *pion_p + (0.0543187)   *Math.pow(pion_p,2) + (-0.0183393)   *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 39 && pip_theta < 40 && pion_p >= 1.2){    dp_pion = 0.0208867   + (-0.0492068)   *1.2    + (0.0543187)   *Math.pow(1.2,2)    + (-0.0183393)   *Math.pow(1.2,3)    + (0)          *Math.pow(1.2,4);}
            if(pip_theta > 40 && pip_theta < 41){                     dp_pion = 0.0148655   + (-0.0203483)   *pion_p + (0.00835867)  *Math.pow(pion_p,2) + (0.00697134)   *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 40 && pip_theta < 41 && pion_p >= 1.0){    dp_pion = 0.0148655   + (-0.0203483)   *1.0    + (0.00835867)  *Math.pow(1.0,2)    + (0.00697134)   *Math.pow(1.0,3)    + (0)          *Math.pow(1.0,4);}
            if(pip_theta > 41 && pip_theta < 42){                     dp_pion = 0.0223585   + (-0.0365262)   *pion_p + (-0.0150027)  *Math.pow(pion_p,2) + (0.0854164)    *Math.pow(pion_p,3) + (-0.0462718) *Math.pow(pion_p,4);}
            if(pip_theta > 41 && pip_theta < 42 && pion_p >= 0.7){    dp_pion = 0.007617;}
            if(pip_theta > 42){                                       dp_pion = 0.0152373   + (-0.0106377)   *pion_p + (-0.0257573)  *Math.pow(pion_p,2) + (0.0344851)    *Math.pow(pion_p,3) + (0)          *Math.pow(pion_p,4);}
            if(pip_theta > 42 && pion_p >= 0.75){                     dp_pion = 0.0152373   + (-0.0106377)   *0.75   + (-0.0257573)  *Math.pow(0.75,2)   + (0.0344851)    *Math.pow(0.75,3)   + (0)          *Math.pow(0.75,4);}
        }
        if(pion_det == 3){ // Central Detector
            if(pip_theta < 39){                                       dp_pion = -0.05        + (-0.0758897) + (0.362231) *pion_p + (-0.542404)   *Math.pow(pion_p,2) + (0.241344)   *Math.pow(pion_p,3);}
            if(pip_theta < 39  && pion_p >= 0.8){                     dp_pion = -0.05        + (-0.0758897) + (0.362231) *0.8    + (-0.542404)   *Math.pow(0.8,2)    + (0.241344)   *Math.pow(0.8,3);}
            if(pip_theta > 39  && pip_theta < 40){                    dp_pion =  0.0355259   + (-0.589712)               *pion_p + (1.4206)      *Math.pow(pion_p,2) + (-1.24179)   *Math.pow(pion_p,3) + (0.365524)  *Math.pow(pion_p,4);}
            if(pip_theta > 39  && pip_theta < 40  && pion_p >= 1.35){ dp_pion =  0.0355259   + (-0.589712)               *1.35   + (1.4206)      *Math.pow(1.35,2)   + (-1.24179)   *Math.pow(1.35,3)   + (0.365524)  *Math.pow(1.35,4);}
            if(pip_theta > 40  && pip_theta < 41){                    dp_pion = -0.252336    + (1.02032)                 *pion_p + (-1.51461)    *Math.pow(pion_p,2) + (0.967772)   *Math.pow(pion_p,3) + (-0.226028) *Math.pow(pion_p,4);}
            if(pip_theta > 40  && pip_theta < 41  && pion_p >= 1.4){  dp_pion = -0.252336    + (1.02032)                 *1.4    + (-1.51461)    *Math.pow(1.4,2)    + (0.967772)   *Math.pow(1.4,3)    + (-0.226028) *Math.pow(1.4,4);}
            if(pip_theta > 41  && pip_theta < 42){                    dp_pion = -0.710129    + (4.49613)                 *pion_p + (-11.01)      *Math.pow(pion_p,2) + (12.9945)    *Math.pow(pion_p,3) + (-7.41641)  *Math.pow(pion_p,4) + (1.63923)   *Math.pow(pion_p,5);}
            if(pip_theta > 41  && pip_theta < 42  && pion_p >= 1.2){  dp_pion = -0.710129    + (4.49613)                 *1.2    + (-11.01)      *Math.pow(1.2,2)    + (12.9945)    *Math.pow(1.2,3)    + (-7.41641)  *Math.pow(1.2,4)    + (1.63923)   *Math.pow(1.2,5);}
            if(pip_theta > 42  && pip_theta < 43){                    dp_pion = -0.0254912   + (0.0851432)               *pion_p + (-0.0968583)  *Math.pow(pion_p,2) + (0.0350334)  *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 42  && pip_theta < 43  && pion_p >= 1.2){  dp_pion = -0.0254912   + (0.0851432)               *1.2    + (-0.0968583)  *Math.pow(1.2,2)    + (0.0350334)  *Math.pow(1.2,3)    + (0)         *Math.pow(1.2,4);}
            if(pip_theta > 43  && pip_theta < 44){                    dp_pion = -0.0115965   + (0.0438726)               *pion_p + (-0.0500474)  *Math.pow(pion_p,2) + (0.0163627)  *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 43  && pip_theta < 44  && pion_p >= 1.4){  dp_pion = -0.0115965   + (0.0438726)               *1.4    + (-0.0500474)  *Math.pow(1.4,2)    + (0.0163627)  *Math.pow(1.4,3)    + (0)         *Math.pow(1.4,4);}
            if(pip_theta > 44  && pip_theta < 45){                    dp_pion =  0.00273414  + (-0.01851)                *pion_p + (0.0377032)   *Math.pow(pion_p,2) + (-0.0226696) *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 44  && pip_theta < 45  && pion_p >= 1){    dp_pion =  0.00273414  + (-0.01851)                *1      + (0.0377032)   *Math.pow(1,2)      + (-0.0226696) *Math.pow(1,3)      + (0)         *Math.pow(1,4);}
            if(pip_theta > 45  && pip_theta < 55){                    dp_pion =  0.0271952   + (-0.25981)                *pion_p + (0.960051)    *Math.pow(pion_p,2) + (-1.76651)   *Math.pow(pion_p,3) + (1.72872)   *Math.pow(pion_p,4) + (-0.856946) *Math.pow(pion_p,5) + (0.167564) *Math.pow(pion_p,6);}
            if(pip_theta > 45  && pip_theta < 55  && pion_p >= 1.4){  dp_pion =  0.0271952   + (-0.25981)                *1.4    + (0.960051)    *Math.pow(1.4,2)    + (-1.76651)   *Math.pow(1.4,3)    + (1.72872)   *Math.pow(1.4,4)    + (-0.856946) *Math.pow(1.4,5)    + (0.167564) *Math.pow(1.4,6);}
            if(pip_theta > 55  && pip_theta < 65){                    dp_pion =  0.00734975  + (-0.0598841)              *pion_p + (0.161495)    *Math.pow(pion_p,2) + (-0.1629)    *Math.pow(pion_p,3) + (0.0530098) *Math.pow(pion_p,4);}
            if(pip_theta > 55  && pip_theta < 65  && pion_p >= 1.2){  dp_pion =  0.00734975  + (-0.0598841)              *1.2    + (0.161495)    *Math.pow(1.2,2)    + (-0.1629)    *Math.pow(1.2,3)    + (0.0530098) *Math.pow(1.2,4);}
            if(pip_theta > 65  && pip_theta < 75){                    dp_pion =  0.00321351  + (-0.0289322)              *pion_p + (0.0786484)   *Math.pow(pion_p,2) + (-0.0607041) *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 65  && pip_theta < 75  && pion_p >= 0.95){ dp_pion =  0.00321351  + (-0.0289322)              *0.95   + (0.0786484)   *Math.pow(0.95,2)   + (-0.0607041) *Math.pow(0.95,3)   + (0)         *Math.pow(0.95,4);}
            if(pip_theta > 75  && pip_theta < 85){                    dp_pion =  0.00644253  + (-0.0543896)              *pion_p + (0.148933)    *Math.pow(pion_p,2) + (-0.1256)    *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 75  && pip_theta < 85  && pion_p >= 0.7){  dp_pion =  0.00644253  + (-0.0543896)              *0.7    + (0.148933)    *Math.pow(0.7,2)    + (-0.1256)    *Math.pow(0.7,3)    + (0)         *Math.pow(0.7,4);}
            if(pip_theta > 85  && pip_theta < 95){                    dp_pion =  0.00671152  + (-0.0537269)              *pion_p + (0.154509)    *Math.pow(pion_p,2) + (-0.147667)  *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 85  && pip_theta < 95  && pion_p >= 0.65){ dp_pion =  0.00671152  + (-0.0537269)              *0.65   + (0.154509)    *Math.pow(0.65,2)   + (-0.147667)  *Math.pow(0.65,3)   + (0)         *Math.pow(0.65,4);}
            if(pip_theta > 95  && pip_theta < 105){                   dp_pion = -0.000709077 + (0.00331818)              *pion_p + (0.0109241)   *Math.pow(pion_p,2) + (-0.0351682) *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 95  && pip_theta < 105 && pion_p >= 0.45){ dp_pion = -0.000709077 + (0.00331818)              *0.45   + (0.0109241)   *Math.pow(0.45,2)   + (-0.0351682) *Math.pow(0.45,3)   + (0)         *Math.pow(0.45,4);}
            if(pip_theta > 105 && pip_theta < 115){                   dp_pion = -0.00260164  + (0.00846919)              *pion_p + (0.0315497)   *Math.pow(pion_p,2) + (-0.105756)  *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 105 && pip_theta < 115 && pion_p >= 0.45){ dp_pion = -0.00260164  + (0.00846919)              *0.45   + (0.0315497)   *Math.pow(0.45,2)   + (-0.105756)  *Math.pow(0.45,3)   + (0)         *Math.pow(0.45,4);}
            if(pip_theta > 115 && pip_theta < 125){                   dp_pion = -0.00544336  + (0.018256)                *pion_p + (0.0664618)   *Math.pow(pion_p,2) + (-0.240312)  *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 115 && pip_theta < 125 && pion_p >= 0.45){ dp_pion = -0.00544336  + (0.018256)                *0.45   + (0.0664618)   *Math.pow(0.45,2)   + (-0.240312)  *Math.pow(0.45,3)   + (0)         *Math.pow(0.45,4);}
            if(pip_theta > 125 && pip_theta < 135){                   dp_pion = -0.00281073  + (-0.00495863)             *pion_p + (-0.00362356) *Math.pow(pion_p,2) + (0.0178764)  *Math.pow(pion_p,3) + (0)         *Math.pow(pion_p,4);}
            if(pip_theta > 125 && pip_theta < 135 && pion_p >= 0.35){ dp_pion = -0.00281073  + (-0.00495863)             *0.35   + (-0.00362356) *Math.pow(0.35,2)   + (0.0178764)  *Math.pow(0.35,3)   + (0)         *Math.pow(0.35,4);}
        }
    }
...
protected double f_pip_loss(DecayProduct pip, int detector, boolean outbending) {
    double p_pip_loss = eloss_pip((double)pip.p(), (double)pip.theta(), detector, outbending);
...
protected double dppC_inbending(float Px, float Py, float Pz, int sec, int ivec, int corEl, int corPip, int corPim, int corPro) { 
    ...
    if(corPro != 0 && ivec == 3){
        if(sec == 1){ // Fall 2018 - Pass 1 Corrections (Only)
            dp = ((1 + Math.signum(1, (pp - 1.4)))/2)*((4.4034e-03)*pp   + (-0.01703))    + ((1 + Math.signum(1, -(pp - 1.4)))/2)*((-0.10898)*(pp  - 1.4)*(pp  - 1.4)  + (-0.09574)*(pp - 1.4)  + ((4.4034e-03)*1.4   + (-0.01703)));
        }
        if(sec == 2){
            dp = ((1 + Math.signum(1, (pp - 1.5)))/2)*((0.01318)*pp      + (-0.03403))    + ((1 + Math.signum(1, -(pp - 1.5)))/2)*((-0.09829)*(pp  - 1.5)*(pp  - 1.5)  +  (-0.0986)*(pp - 1.5)  + ((0.01318)*1.5      + (-0.03403)));
        }
        if(sec == 3){
            dp = ((1 + Math.signum(1, (pp - 1.05)))/2)*((-4.7052e-03)*pp + (1.2410e-03))  + ((1 + Math.signum(1, -(pp - 1.05)))/2)*((-0.22721)*(pp - 1.05)*(pp - 1.05) + (-0.09702)*(pp - 1.05) + ((-4.7052e-03)*1.05 + (1.2410e-03)));
        }
        if(sec == 4){
            dp = ((1 + Math.signum(1, (pp - 1.4)))/2)*((-1.0900e-03)*pp  + (-4.0573e-03)) + ((1 + Math.signum(1, -(pp - 1.4)))/2)*((-0.09236)*(pp  - 1.4)*(pp  - 1.4)  +   (-0.073)*(pp - 1.4)  + ((-1.0900e-03)*1.4  + (-4.0573e-03)));
        }
        if(sec == 5){
            dp = ((1 + Math.signum(1, (pp - 1.5)))/2)*((7.3965e-03)*pp   + (-0.02428))    + ((1 + Math.signum(1, -(pp - 1.5)))/2)*((-0.09539)*(pp  - 1.5)*(pp  - 1.5)  + (-0.09263)*(pp - 1.5)  + ((7.3965e-03)*1.5   + (-0.02428)));
        }
        if(sec == 6){
            dp = ((1 + Math.signum(1, (pp - 1.15)))/2)*((-7.6214e-03)*pp + (8.1014e-03))  + ((1 + Math.signum(1, -(pp - 1.15)))/2)*((-0.12718)*(pp - 1.15)*(pp - 1.15) + (-0.06626)*(pp - 1.15) + ((-7.6214e-03)*1.15 + (8.1014e-03)));
        }
    }
