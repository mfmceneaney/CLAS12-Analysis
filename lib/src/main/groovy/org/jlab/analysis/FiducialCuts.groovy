...
public class FiducialCuts {
    ...
    */
    protected boolean DC_fiducial_cut_theta_phi(int j, int region, int part_pid){
        ...
        final def maxparams_in = [ // DIM = (6,6,3,4) (pid,sector,region,param)
        ...
        final def minparams_in = [ // DIM = (6,6,3,4)
        ...
        final def maxparams_out = [ // DIM = (6,6,3,4)
        ...
        final def minparams_out = [ // DIM = (6,6,3,4)
    ...
    */
    protected boolean DC_fiducial_cut_XY(int j, int region, int part_pid) {
        ...
        // Fitted values for inbending
        final def maxparams_in = // DIM = (6,6,3,2) (pid,sector,region,param)
        ...
        final def minparams_in = // DIM = (6,6,3,2) (pid,sector,region,param)
        ...
        // Fitted values for outbending
        final def maxparams_out = [ // DIM = (6,6,3,2) (pid,sector,region,param)
        ...
        final def minparams_out = [ // DIM = (6,6,3,2) (pid,sector,region,param)
