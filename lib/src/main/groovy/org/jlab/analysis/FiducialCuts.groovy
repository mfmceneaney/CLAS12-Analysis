...
public class FiducialCuts {
    ...
    protected boolean applyCuts(int runnum_, int current_part, int pid_, Event event_, HipoReader reader_) {
        ...
        if(pid_==11) { // electrons
            ...
            if (inbending) {
                ...
                for(int r=0; r<nReg; r++) { cutHadDC[r] = part_DC_Traj_found[0]>0 ? this.DC_fiducial_cut_XY(current_part, r+1, pid_) : false; }
            }
    ...
    */
    protected boolean DC_fiducial_cut_theta_phi(int j, int region, int part_pid){
        ...
        final double[][][][] maxparams_in = [ // DIM = (6,6,3,4) (pid,sector,region,param)
        ...
        final double[][][][] minparams_in = [ // DIM = (6,6,3,4)
        ...
        final double[][][][] maxparams_out = [ // DIM = (6,6,3,4)
        ...
        final double[][][][] minparams_out = [ // DIM = (6,6,3,4)
    ...
    */
    protected boolean DC_fiducial_cut_XY(int j, int region, int part_pid) {
        ...
        // Fitted values for inbending
        final double[][][][] maxparams_in = // DIM = (6,6,3,2) (pid,sector,region,param)
        ...
        final double[][][][] minparams_in = // DIM = (6,6,3,2) (pid,sector,region,param)
        ...
        // Fitted values for outbending
        final double[][][][] maxparams_out = [ // DIM = (6,6,3,2) (pid,sector,region,param)
            ...
            [[-4.59187, 0.547947],[-18.6261, 0.617462],[-4.56516, 0.318076]],[[-4.51481, 0.54217],[-15.5234, 0.586091],[-3.33085, 0.406969]]]];

        final double[][][][] minparams_out = [ // DIM = (6,6,3,2) (pid,sector,region,param)
            ...
            [[4.71687, -0.547772],[18.0103, -0.604119],[10.7901, -0.437388]],[[7.17946, -0.57369],[11.2732, -0.397794],[-2.79229, -0.137468]]]];
